Lightweight::Engine.routes.draw do
  ...
  # in_place_editing routes
  match "/pages/:id/:action", :controller => 'interactive_pages', :constraints => { :id => /\d+/ } 
  # Can I also constrain the action name, e.g. :action => /set_lightweight_/ ? 
end
